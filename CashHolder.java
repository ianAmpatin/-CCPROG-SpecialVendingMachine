...
public class CashHolder {
     ...
     * @return true if the cash was added successfully, false otherwise
     */
    ...
    Denomination greatest = this.getLeast();
    ...
    public double getTotal () {
        ...
        for (Denomination denom : holderDenom) {
            ...
            //System.out.println("Value: " + denom.getValue() + " | Quantity: " + this.countDenomination(denom.getValue()));
        }
