...
public class ProcessingMessage extends JFrame{
    ...
    */
     ...
     * @param change is the change that will be shown to the client
     */

     public ProcessingMessage(Item item, double change) {
          this();
          String message = "No Item Selected";
      
          try {
              message = "Purchasing Item...\nSelected item is <" + item.getName() + ">\nCost of Item: Php " + item.getPrice() + "\nThank you! Have A good Day";
              message += "\n You have received a change of Php " + change;
     ...
     */
     ...
     public ProcessingMessage(CompoundSlot slot, double change) {
          this();
